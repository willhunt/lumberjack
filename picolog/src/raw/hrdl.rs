...
//! Generated by bindgen from HRDL.h. Do not edit by hand.
//! Regenerate with the command in picolog/README.md.
...
pub type enHRDLInputs = ::std::os::raw::c_int;
...
pub type enHRDLDigitalIoChannel = ::std::os::raw::c_int;
...
pub type enHRDLRange = ::std::os::raw::c_int;
...
pub type enHRDLConversionTime = ::std::os::raw::c_int;
...
pub type enHRDLInfo = ::std::os::raw::c_int;
...
pub type enHRDLErrorCode = ::std::os::raw::c_int;
...
pub type enSettingsError = ::std::os::raw::c_int;
...
pub type enBlockMethod = ::std::os::raw::c_int;
